(function(){
	...
	var url = "http://api.flickr.com/services/rest/?format=json&method=flickr.photosets.getPhotos&photoset_id=" + set_id + "&per_page=1000&page=1&api_key=" + api_key + "&jsoncallback=" + callback;

	// by user
	var user_id = "8431584@N06";
	var url = "http://api.flickr.com/services/rest/?format=json&method=flickr.people.getPhotos&user_id=" + user_id + "&per_page=1000&page=1&api_key=" + api_key + "&jsoncallback=" + callback;
